...
class Zend_Gdata_AuthSub
{
    ...
    const AUTHSUB_REQUEST_URI      = 'http://www.google.com/accounts/AuthSubRequest';

    const AUTHSUB_SESSION_TOKEN_URI = 'http://www.google.com/accounts/AuthSubSessionToken';

    const AUTHSUB_REVOKE_TOKEN_URI  = 'http://www.google.com/accounts/AuthSubRevokeToken';

    const AUTHSUB_TOKEN_INFO_URI    = 'http://www.google.com/accounts/AuthSubTokenInfo';
